            ...
            <_0:ModelCRUD>
              ...
              <_0:DataRow>
                <_0:field column="Name">
                  <_0:val>../../documents/idempiere-logo.png</_0:val>
                </_0:field>
  ...
  <soap:Body>
    <ns1:compositeOperationResponse xmlns:ns1="http://idempiere.org/ADInterface/1_0">
      <CompositeResponses xmlns="http://idempiere.org/ADInterface/1_0">
        <CompositeResponse>
          <StandardResponse RecordID="1000012">
            <outputFields>
              <outputField column="AD_Image_ID" value="1000012"/>
              ...
              <outputField column="Name" value="../../documents/idempiere-logo.png"/>
            </outputFields>
          </StandardResponse>
          <StandardResponse RecordID="1000098">
            <outputFields>
              <outputField column="C_BPartner_ID" value="1000098"/>
              <outputField column="Name" value="Test BPartner"/>
              <outputField column="TaxID" value="987654321"/>
              <outputField column="Value" value="2457216"/>
            </outputFields>
          </StandardResponse>
        </CompositeResponse>
      </CompositeResponses>
...
Response: WebServiceResponseModel.StandardResponse
---------------------------------------------
Web Service Type: CompositeBPartnerTest
Attempts: 1
Time: 3103
```
